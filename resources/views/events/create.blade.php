...
<div class="px-4 py-12 lg:py-20 animate-fade-in">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-12">
            ...
            <div class="text-4xl md:text-5xl font-black text-white tracking-tight">Create New Event</div>
        </div>

        <div class="relative overflow-hidden rounded-2xl bg-surface-primary border border-edge-strong shadow-lux-lg p-8 md:p-12">
            <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="relative z-10 space-y-10">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="space-y-4 md:col-span-2">
                        ...
                        <input type="text" name="title" placeholder="Enter event title" class="input-cyber w-full" required>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative group">
                            <input type="datetime-local" name="date" class="input-cyber w-full cursor-pointer" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <input type="text" name="location" placeholder="Enter full address or venue" class="input-cyber w-full">
                    </div>

                    <!-- Valuation -->
                    <div class="space-y-4">
                        <label class="text-sm font-semibold text-gray-300">Ticket Price (₦)</label>
                        <input type="number" step="0.01" name="price" placeholder="0.00" class="input-cyber w-full" required>
                    </div>

                    <!-- Supply Protocol -->
                    <div class="space-y-4">
                        <label class="text-sm font-semibold text-gray-300">Available Tickets</label>
                        <input type="number" name="available_tickets" placeholder="Total number of tickets" class="input-cyber w-full" required>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <select name="bank_code" class="input-cyber w-full cursor-pointer text-sm">
                                    ...
                                    <option value="999992">OPay Digital Services (Paycom)</option>
                                    <option value="090405">Moniepoint MFB</option>
                                    <option value="090281">PalmPay</option>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="account_number" placeholder="10-digit account number" class="input-cyber w-full text-sm" pattern="\d{10}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 md:col-span-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Tell attendees what to expect..." class="input-cyber w-full resize-none"></textarea>
                    </div>
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center pointer-events-none border-2 border-dashed border-edge-strong rounded-xl group-hover:border-gold/50 transition-all bg-surface-elevated/50 group-hover:bg-gold/5">
                                <span class="text-sm font-semibold text-gray-400 flex flex-col items-center gap-2 group-hover:text-gold transition-colors">
                                    ...
                                    Upload Banner Image (1200x600 recommended)
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-8 border-t border-edge-subtle flex flex-col md:flex-row items-center justify-between gap-6">
                    <p class="text-xs text-gray-500 font-semibold">
                        Your event will be published immediately to the platform.
                    </p>
