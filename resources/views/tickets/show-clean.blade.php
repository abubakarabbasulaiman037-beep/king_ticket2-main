            ...
            <div class="md:col-span-8 border-r border-edge-default print:border-r-0">
                ...
                <div class="relative aspect-[16/6] overflow-hidden bg-gradient-to-br from-gold/5 to-purple-600/5">
                    @if($ticket->event->banner)
                        <img src="{{ $ticket->event->bannerUrl() }}" class="w-full h-full object-cover opacity-60" alt="{{ $ticket->event->title }}">
                    @endif
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex justify-center">
                            <div class="border-2 border-gold/30 p-3 rounded-lg bg-white/5">
                                {!! $ticket->generateQRCode() ?? '<div class="w-32 h-32 bg-surface-secondary flex items-center justify-center text-gray-500 text-xs">QR Code</div>' !!}
                            </div>
                        </div>
                    </div>
